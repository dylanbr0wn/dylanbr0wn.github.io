...
class SpeGltfDecoder {
    ...
    decode(e) {
        e && (this.mGltfSceneGraph = e),
            ...
            void 0 !== this.mGltfSceneGraph.spline &&
                ...
                (this.mSceneOptions.viewWidth =
                    void 0 !== this.mGltfSceneGraph.spline.viewWidth
                        ...
                        : document.getElementById(
                              this.mGltfSceneGraph.spline.elementID
                ...
                (this.mSceneOptions.elementID =
                    void 0 !== this.mGltfSceneGraph.spline.elementID
                        ? this.mGltfSceneGraph.spline.elementID
                        : "canvas3d"));
        ...
        if (t) {
            if (
                ...
                this.mGltfSceneGraph.spline &&
                    this.mGltfSceneGraph.spline.images)
            ) {
            ...
            if (
                ...
                for (const [t, i] of Object.entries(e))
                    this.mInteractionStates[
                        t
                    ] = new InteractionState().fromJSON(i, SPE.CachedTextures);
            }
        }
        ...
        if (
            ...
            const e = this.mGltfSceneGraph.extensions.KHR_lights_punctual
                .lights;
        ...
        if (
            ...
            for (let t = 0; t < n.length; t++) {
                const i = n[t];
                if (
                    void 0 !== i.spe_interaction &&
                    null !== i.spe_interaction
                ) {
        ...
        for (; !h.empty(); ) {
            ...
            if (t < this.mNodes.length && t >= 0) {
                ...
                if (void 0 !== r)
                    for (let t = 0; t < r.length; t++) h.push([r[t], e]);
            }
        }
        if (
            void 0 !== this.mGltfSceneGraph.spline &&
        ...
        if (
            ...
            e < this.mNodes.length &&
                e >= 0 &&
                (this.mSceneCamera = this.mNodes[e]);
        }
        ...
        if ("hemispheric" === e.type) {
            ...
            (t.castShadow = void 0 !== i.castShadow && i.castShadow),
                (t.shadow.camera.right =
                    void 0 !== i.shadowmapViewRight
                        ? i.shadowmapViewRight
                        : 1250),
                (t.shadow.camera.left =
                    void 0 !== i.shadowmapViewLeft
                        ? i.shadowmapViewLeft
                        : -1250),
                (t.shadow.camera.top =
                    void 0 !== i.shadowmapViewTop ? i.shadowmapViewTop : 1250),
                (t.shadow.camera.bottom =
                    void 0 !== i.shadowmapViewBottom
                        ? i.shadowmapViewBottom
                        : -1250),
    ...
    _constructGeometricData() {
        ...
        for (let e = 0; e < i.length; e++)
            r.push(this._decodeBufferView(i[e], t));
        ...
        if (void 0 !== e.camera) {
            ...
            if (t < this.mCameras.length && t >= 0) {
                ...
                (i.visible = void 0 === e.visible || e.visible),
                    ...
                    this.mNodes.push(i);
                const r =
                    void 0 !== e.uuid ? e.uuid : THREE.MathUtils.generateUUID();
                this.mObjects[r] = i;
            } else
                console.error(
...
class SpeLayer {
    ...
    initializeUniformsAndDefines(e) {
        console.error(
            "SpeLayer::initializeUniformsAndDefines >>> virtual method"
        );
    }
    ...
    initializeUniformsAndDefines(e) {
        (this.mDefines.SPE_USE_LAYER_GRADIENT = ""),
            ...
            (this.mUniforms[`f${this.mId}_steps`] = {
                value:
                    void 0 !== e.steps ? e.steps.value : new Array(10).fill(),
            }),
...
class SpeLayersList {
    ...
    addLayerBeforeAt(e, t) {
        const i =
                void 0 !== e.id ? e.id : 100 + Math.floor(999 * Math.random()),
    ...
    getDefinesCode() {
        let e = "",
            t = this.mHead;
        for (; t; ) {
            for (let [i, r] of Object.entries(t.defines))
                e += `#define ${i} ${r}\n`;
            t = t.next;
        }
        return e;
...
class SpeTextChar3D extends SpeIMesh {
    constructor(e, t) {
        ...
        super(s.geometry, t),
            ...
            (this.mLetterSpacing =
                void 0 !== e.letterSpacing ? e.letterSpacing : 1),
...
class SpeLoaderManager {
    ...
    run(e) {
        ...
        const t = void 0 !== this.mAssets.fonts ? this.mAssets.fonts : [],
            ...
            a =
                void 0 !== this.mAssets.animations
                    ? this.mAssets.animations
                    : [];
        if (
            ((this.mNumAssetsLoaded = 0),
            ...
            for (let i = 0; i < t.length; i++) {
                ...
                r.load(s, function (t) {
                    (SpeFontsCache[a] = t),
                        e.mNumAssetsLoaded++,
                        e.mNumAssetsLoaded === e.mNumAssetsToLoad &&
                            e.mOnFinishCallback();
                });
            }
        }
...
class SpeRuntime {
    ...
    onResize() {
        this.mRunning &&
            ...
            this.mRenderer &&
                this.mRenderer.setSize(
                    this.mViewportWidth,
                    this.mViewportHeight
                ));
    }
    loadFromGltf(e) {
        ...
        const s =
                void 0 !== this.mSceneOptions.bgColor
                    ...
                    : new THREE.Color(1644825),
            n =
                void 0 !== this.mSceneOptions.bgAlpha
                    ? this.mSceneOptions.bgAlpha
                    : 0;
        this.mRenderer.setClearColor(s, n),
            ...
            this.mSceneOptions.useOrbitControls &&
                ...
                this.mOrbitControls.target.fromArray(
                    this.mSceneOptions.orbitTarget
                ),
...
(THREE.OrbitControls = function (e, t) {
        ...
        (this.update =
            ...
            function () {
                ...
                return (
                    ...
                    (f.phi = Math.max(
                        h.minPolarAngle,
                        Math.min(h.maxPolarAngle, f.phi)
                    )),
                    f.makeSafe(),
                    (f.radius *= g),
                    (f.radius = Math.max(
    ...
    function Y(e) {
        var t = e.touches[0].pageX - e.touches[1].pageX,
            ...
            r = Math.sqrt(t * t + i * i);
        M.set(0, r),
            L.set(0, Math.pow(M.y / w.y, h.zoomSpeed)),
            $(L.y),
            w.copy(M);
    }
    function W(e) {
                            ...
                            case m.PAN:
                                ...
                                !(function (e) {
                                    T.set(e.clientX, e.clientY),
                                        R.subVectors(T, b).multiplyScalar(
                                            h.panSpeed
                                        ),
                                        O(R.x, R.y),
                                        b.copy(T),
    ...
    (Interaction.prototype = {
        ...
        hasEventType: function (e, t) {
            return e === InteractionEvent.TYPE.KEY_DOWN ||
                ...
                ? void 0 !== t &&
                      this.events.some(i => i.type === e && i.key === t)
                : this.events.some(t => t.type === e);
        },
        newEvent: function () {
            const e = InteractionEvent.ORDER.find(
                    e => !1 === this.hasEventType(e)
                ),
        ...
        animateMaterial: function (e) {
            ...
            const t = (e, t, i, r) => {
                    ...
                    for (
                        let e = 0,
                            s = (r = void 0 !== r ? r : t.paramNames).length;
                        e < s;
                        ++e
                    ) {
                        const s = r[e],
    ...
    (InteractionEvent.prototype = {
        ...
        newTarget: function (e) {
            ...
            return (
                ...
                e.interaction.states.length > 0 &&
                    (t.state =
                        e.interaction.states[e.interaction.states.length - 1]),
                this.targets.push(t),
        ...
        removeTarget: function (e) {
            Interaction.targets.delete(this.targets[e]),
        ...
        copy: function (e) {
            if (
                ...
                if (!0 === Array.isArray(e.material)) {
                    ...
                    for (let t = 0, i = e.material.length; t < i; ++t)
                        this.material.push({
                            layersList: e.material[t].layersList.map(e =>
                                e.clone()
                            ),
                        });
                } else
            ...
            if (
                ...
                if (!0 === Array.isArray(this.material)) {
                    ...
                    for (let i = 0, r = this.material.length; i < r; ++i)
                        t.material.push({
                            layersList: this.material[i].layersList.map(t =>
                                t.toJSON(e)
                            ),
                        });
                } else
                    t.material = {
                        layersList: this.material.layersList.map(t =>
                            t.toJSON(e)
                        ),
                    };
            return (
            ...
            return (
                ...
                void 0 !== e.springControls
                    ...
                    : ((this.springParameters.mass = e.springParameters.mass),
                      (this.springParameters.stiffness =
                          e.springParameters.stiffness),
                      (this.springParameters.damping =
                          e.springParameters.damping),
                      (this.springParameters.velocity =
                          e.springParameters.velocity)),
                this
            );
        },
    }),
    (InteractionStatesManager.prototype = {
        ...
        updateCamera() {
            void 0 !== this.i.selectedState &&
                (this.i.states[this.i.selectedState].updateMatrix(
                    this.i.object
                ),
                this.i.states[this.i.selectedState].updateCamera(
                    this.i.object
                ));
        },
        updateGeometry() {
            void 0 !== this.i.selectedState &&
                ...
                this.i.states[this.i.selectedState].updateGeometry(
                    this.i.object
                ));
        },
        updateSceneGraph(e) {
        ...
        removeMaterialLayer(e) {
            ...
            if (!0 === Array.isArray(this.i.object.material))
                for (let i = 0, r = this.i.states.length; i < r; ++i) {
                    ...
                    t.push({ layer: a.layersList[e] }),
                        a.layersList.splice(e, 1);
                }
            else
                for (let i = 0, r = this.i.states.length; i < r; ++i) {
                    const r = this.i.states[i].material;
                    t.push({ layer: r.layersList[e] }),
                        r.layersList.splice(e, 1);
                }
        ...
        changeMaterialLayer(e) {
            ...
            if (!0 === Array.isArray(this.i.object.material)) {
                const r = this.i.object.userData.selectedMaterial,
                    a = this.i.states[this.i.selectedState].material[r]
                        .layersList;
                ...
                const r = this.i.states[this.i.selectedState].material
                    .layersList;
        ...
        restoreMaterialLayerChanged(e) {
            if (0 !== this.i.states.length)
                if (!0 === Array.isArray(this.i.object.material)) {
                    const t = this.i.object.userData.selectedMaterial;
                    for (let i = 0, r = this.i.states.length; i < r; ++i)
                        this.i.states[i].material[t].layersList[e.pos] =
                            e.states[i].layer;
                } else
                    for (let t = 0, i = this.i.states.length; t < i; ++t)
                        this.i.states[t].material.layersList[e.pos] =
                            e.states[t].layer;
        },
        ...
        restoreMaterialLayersSet(e) {
            if (Array.isArray(this.i.object.material)) {
                ...
                for (let i = 0, r = this.i.states.length; i < r; ++i)
                    this.i.states[i].material[t].layersList =
                        e.states[i].layersList;
            } else
                for (let t = 0, i = this.i.states.length; t < i; ++t)
                    this.i.states[t].material.layersList =
                        e.states[t].layersList;
        },
    }),
        ...
        (this.build = function ({
            ...
            (this.buildFromGeometry = function (
                e,
                {
                    ...
                    cornerRadiusBottom: c = e.userData.parameters
                        .cornerRadiusBottom,
...
(SPE.CylinderGeometry.RoundedCylinderBufferGeometry = RoundedCylinderBufferGeometry),
    ...
    (SPE.PolygonGeometry = new (function () {
        (this.build = function ({
            ...
            return (
                0 !== r &&
                    SPE.Geometry.Utils.roundShapePolygon(d, d.getPoints(), r),
                ((o =
                    a > 0
            ...
            (this.buildFromGeometry = function (
                e,
                {
                    ...
                    extrudeBevelSize: n = e.userData.parameters
                        .extrudeBevelSize,
                    extrudeBevelSegments: o = e.userData.parameters
                        .extrudeBevelSegments,
                }
            ) {
                return this.build({
...
class RoundedPyramidBufferGeometry extends THREE.BufferGeometry {
    constructor(e = 0.5, t = 1, i = 4, r = 1, a = !1, s = 0, n = 4) {
                ...
                if ((l.push(U, B, G), s > 0)) {
                    ...
                    C.concat(f);
                    {
                        ...
                        for (let e = 0; e < E; e++) {
                            ...
                            l.push(i[1], t[0], i[0]);
                            for (let e = 1; e <= r; e++)
                                l.push(t[e], t[e - 1], i[e]),
                                    l.push(i[e + 1], t[e], i[e]);
                        }
                    }
                }
            }
        ...
        this.setIndex(l),
            this.setAttribute(
                "position",
                new THREE.Float32BufferAttribute(c, 3)
            ),
...
(SPE.RectangleGeometry = new (function () {
    (this.build = function ({
        ...
        (this.buildFromGeometry = function (
            e,
            {
                ...
                extrudeBevelSegments: h = e.userData.parameters
                    .extrudeBevelSegments,
            }
        ) {
            return this.build({
    ...
    (SPE.StarGeometry = new (function () {
        (this.build = function ({
            ...
            return (
                0 !== a &&
                    SPE.Geometry.Utils.roundShapePolygon(E, E.getPoints(), a),
                ((l =
                    n > 0
            ...
            (this.buildFromGeometry = function (
                e,
                {
                    width: t = e.userData.parameters.width,
                    height: i = e.userData.parameters.height,
                    innerRadiusPercent: r = e.userData.parameters
                        .innerRadiusPercent,
                    ...
                    extrudeBevelSize: h = e.userData.parameters
                        .extrudeBevelSize,
                    extrudeBevelSegments: l = e.userData.parameters
                        .extrudeBevelSegments,
                }
            ) {
                return this.build({
        ...
        (this.build = function ({
            ...
            (this.buildFromGeometry = function (
                e,
                {
                    ...
                    verticalSegments: s = e.userData.parameters
                        .verticalSegments,
        ...
        (this.build = function ({
            ...
            (this.buildFromGeometry = function (
                e,
                {
                    ...
                    extrudeBevelSize: s = e.userData.parameters
                        .extrudeBevelSize,
                    extrudeBevelSegments: n = e.userData.parameters
                        .extrudeBevelSegments,
    ...
    (SPE.Geometry.Utils = new (function () {
        (this.roundShapePolygon = function (e, t, i) {
            ...
            (this.resizeGeometry = function (
                e,
                { width: t, height: i, depth: r }
            ) {
...
class Cloner extends THREE.Object3D {
    constructor(e, t = {}) {
        ...
        (this.parameters = {
            ...
            ra_radius:
                void 0 !== t.ra_radius ? t.ra_radius : 2 * Math.max(i.x, i.y),
            ...
            ra_scale:
                void 0 !== t.ra_scale
                    ...
                    : new THREE.Vector3(),
            ra_rotation:
                void 0 !== t.ra_rotation
                    ? t.ra_rotation.clone()
                    : new THREE.Euler(),
            ra_position:
                void 0 !== t.ra_position
                    ? t.ra_position.clone()
                    : new THREE.Vector3(),
            li_scale:
                void 0 !== t.li_scale
...
(SPE.CombinedCamera = class extends (
    ...
    setViewOffset(e, t, i, r, a, s) {
        this.isPerspectiveCamera
            ? (this.perspCamera.setViewOffset(e, t, i, r, a, s),
              this.toPerspective())
            : this.isOrthographicCamera &&
        ...
        raycast(e, t) {
            ...
            if (
                ...
                var o,
                    ...
                    f = s.drawRange;
                for (
                    d = Math.max(0, f.start),
                        m = Math.min(u.count, f.start + f.count);
                    d < m;
                    d += 3
                )
                    (h = u.getX(d)),
    ...
    (SPE.LightSpot = class extends (
        ...
        copy(e, t) {
            ...
            if (
                ...
                (e.children = i),
                this.userDataFromJson(this.userData),
                void 0 !== e.enableHelper &&
                    (this.enableHelper = e.enableHelper),
                void 0 !== e.objectHelper &&
                    (this.objectHelper.visible = e.objectHelper.visible),
                void 0 !== e.interaction &&
                    this.interaction.copy(e.interaction),
                !0 === t)
            )
                for (let t = 0, r = i.length; t < r; ++t) {
                    const i = e.children[t];
        ...
        function o(o) {
            if (void 0 !== o.geometry) {
                ...
                void 0 !== o.geometryHelper && !0 === n
                    ? (a.setFromArray(
                          o.geometryHelper.getAttribute("position").array
                      ),
                      a.getCenter(s),
    ...
    (SPE.Math = class {
        ...
        static rotatePosition3D(e, t) {
            return e
                .clone()
                .applyMatrix3(SPE.Math.getRotateMatrix(t.x, t.y, t.z));
        }
        ...
        static round(e, t) {
            let i = (e + "e").split("e");
            return +(
                (i = (Math.round(i[0] + "e" + (+i[1] + t)) + "e").split(
                    "e"
                ))[0] +
                "e" +
                (+i[1] - t)
        ...
        static getObjectSize(e) {
            ...
            return (
                ...
                (t.x =
                    e.geometry.boundingBox.max.x -
                    e.geometry.boundingBox.min.x),
                (t.y =
                    e.geometry.boundingBox.max.y -
                    e.geometry.boundingBox.min.y),
                (t.z =
                    e.geometry.boundingBox.max.z -
                    e.geometry.boundingBox.min.z),
                t
            );
        }
        ...
        static fixUvs(e, t, i) {
            for (let r = 0; r < e.attributes.uv.array.length; r += 2)
                (e.attributes.uv.array[r] =
                    (e.attributes.uv.array[r] + t / 2) / t),
